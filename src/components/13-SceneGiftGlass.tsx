...
import { TamburinsGlassBox } from "@/components/TamburinsGlassBox";

/** 12장과 같은 자리에 같은 글을 두고, 우측 그림만 유리 상자로 바꾼 장 */
export function SceneGiftGlass() {
  return (
    <SceneCase
