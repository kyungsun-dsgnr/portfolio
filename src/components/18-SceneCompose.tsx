...
import { TamburinsComposeScreen } from "@/components/TamburinsComposeScreen";
...
export function SceneCompose() {
  ...
  return (
    <div ref={ref} className="page-grid" data-visible={inView || undefined}>
      ...
      <div
        className="compose-stage rise col-start-6 col-span-2 row-start-1 row-span-6"
        style={{ "--delay": "0.32s" } as CSSProperties}
      >
        <div className="compose-frame" style={{ width: px(SHOT_W) }}>
          <TamburinsComposeScreen />
        </div>
      </div>
    </div>
  );
