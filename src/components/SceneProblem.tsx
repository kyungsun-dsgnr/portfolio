...
const POINTS = [
  {
    ...
    place: "col-start-2 col-span-2 row-start-4 row-span-2",
  },
  {
    index: "02",
    title: "Local Context",
    body: "탐색은 접속 국가와 현재 위치를 중심으로 시작되어, 가까운 지역의 매장 정보에 집중됩니다.",
    place: "col-start-6 col-span-2 row-start-3 row-span-2",
  },
  {
    index: "03",
    title: "Limited Global View",
    body: "각 매장은 개별 정보로 확인되지만, 전 세계 여러 도시와 연결된 브랜드의 확장감은 한눈에 드러나지 않습니다.",
    place: "col-start-6 col-span-2 row-start-5 row-span-2 issue-low",
  },
];
